...
namespace Voyager.Services.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ServicesDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ServicesEfCoreEntityExtensionMappings to extend the IdentityUser entity
